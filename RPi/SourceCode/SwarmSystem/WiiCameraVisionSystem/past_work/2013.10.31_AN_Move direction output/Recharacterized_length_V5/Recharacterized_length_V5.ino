...
void moveQuad(){
  ...
  int lat_R_tolerance = 10;   // Observed resolution
  int lat_L_tolerance = 10;   // Observed resolution
  int len_tolerance = 2;    // inches
...
//  Serial.print("DOb12 = ");
  Serial.print(dOb12);
  Serial.print("/");
  Serial.println(dOb23);
  
//  //Adjusting Laterally (Roll)
//  if(dOb12 > (dOb23 - lat_tolerance)){
//    //Correct clockwise
//    Serial.println("Left");
...
//  }
//  else if((dOb12 - lat_tolerance) < dOb23 ){
...
// Call forward or backwords movement  
// Delay added to make readings easier to see
  if (actual_depth > (ideal_depth + len_tolerance)){
    //Move towards beacon

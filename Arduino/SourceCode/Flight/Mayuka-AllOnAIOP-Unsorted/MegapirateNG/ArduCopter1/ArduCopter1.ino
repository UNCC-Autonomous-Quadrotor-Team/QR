...
static uint8_t pinRcChannel[8] = {
  1, 3, 2, 0, 4,5,6,7}; //Graupner/Spektrum
#elif TX_CHANNEL_SET == TX_standard
static uint8_t pinRcChannel[8] = {
  0, 1, 2, 3, 4,5,6,7}; //standard  PPM layout Robbe/Hitec/Sanwa
#elif TX_CHANNEL_SET == TX_set2
static uint8_t pinRcChannel[8] = {
  1, 0, 2, 3, 4,5,6,7}; // some Hitec/Sanwa/others
#elif TX_CHANNEL_SET == TX_mwi
static uint8_t pinRcChannel[8] = {
  1, 2, 0, 3, 4,5,6,7}; // mapped multiwii to APM layout
#endif
